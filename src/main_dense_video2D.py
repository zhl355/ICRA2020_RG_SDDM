...
# -*- coding: utf-8 -*-
"""
Creating 2D top-view visualization for dense env to display map update
and replanning process on occupancy grid map.
...
from my_utils import debug_print, flist1D, tic, toc
...
if __name__ == '__main__':
    log_dense = '../log/dense_full_ellipse.pkl'
#    log_circular = '../log/log_sparse_ellipsePd_diag_1_4.pkl'
    print('input file is %s' %(log_dense))
    viewer = GovLogViewer(log_dense)
    viewer.save_frames_dense()
    print('Result generated.')
toc(t1, "create dense 2D frames")
